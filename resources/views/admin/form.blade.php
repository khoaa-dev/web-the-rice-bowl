...
@section('css')
    <!-- bootstrap-wysiwyg -->
    <link href="{{ asset('public/front-end/admin/vendors/google-code-prettify/bin/prettify.min.css') }}" rel="stylesheet">
    <!-- Select2 -->
    <link href="{{ asset('public/front-end/admin/vendors/select2/dist/css/select2.min.css') }}" rel="stylesheet">
    <!-- Switchery -->
    <link href="{{ asset('public/front-end/admin/vendors/switchery/dist/switchery.min.css') }}" rel="stylesheet">
    <!-- starrr -->
    <link href="{{ asset('public/front-end/admin/vendors/starrr/dist/starrr.css') }}" rel="stylesheet">
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form" data-parsley-validate>
                                ...
                                <p style="padding: 5px;">
                                    ...
                                    <input type="checkbox" name="hobbies[]" id="hobby4" value="sleep"
                                        class="flat" /> Sleeping
                                    <br />
                                <p>
                                        ...
                                        <div class="radio">
                                            <label>
                                                <input type="radio" class="flat" name="iCheck3"
                                                    disabled="disabled" checked> Disabled & Checked
                                            </label>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <p class="font-gray-dark">
                        Using the grid system you can control the position of the labels. The form example below has the
                        <b>col-md-10</b> which sets the width to 10/12 and <b>center-margin</b> which centers it.
                    </p>
                    <form class="form-horizontal form-label-left">
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-md-3" for="last-name">Last Name <span
                                    class="required">*</span>
                            </label>
                            <div class="col-md-7">
...
@section('js')
    ...
    <script src="{{ asset('public/front-end/admin/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js') }}"></script>
    <!-- bootstrap-daterangepicker -->
    ...
    <!-- bootstrap-wysiwyg -->
    <script src="{{ asset('public/front-end/admin/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js') }}"></script>
    <script src="{{ asset('public/front-end/admin/vendors/jquery.hotkeys/jquery.hotkeys.js') }}"></script>
    <script src="{{ asset('public/front-end/admin/vendors/google-code-prettify/src/prettify.js') }}"></script>
    <!-- jQuery Tags Input -->
    <script src="{{ asset('public/front-end/admin/vendors/jquery.tagsinput/src/jquery.tagsinput.js') }}"></script>
    <!-- Switchery -->
    <script src="{{ asset('public/front-end/admin/vendors/switchery/dist/switchery.min.js') }}"></script>
    <!-- Select2 -->
    <script src="{{ asset('public/front-end/admin/vendors/select2/dist/js/select2.full.min.js') }}"></script>
    <!-- Parsley -->
    <script src="{{ asset('public/front-end/admin/vendors/parsleyjs/dist/parsley.min.js') }}"></script>
    <!-- Autosize -->
    <script src="{{ asset('public/front-end/admin/vendors/autosize/dist/autosize.min.js') }}"></script>
    <!-- jQuery autocomplete -->
    <script src="{{ asset('public/front-end/admin/vendors/devbridge-autocomplete/dist/jquery.autocomplete.min.js') }}">
    </script>
    <!-- starrr -->
    <script src="{{ asset('public/front-end/admin/vendors/starrr/dist/starrr.js') }}"></script>
@endsection
