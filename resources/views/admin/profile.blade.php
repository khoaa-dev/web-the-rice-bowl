                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        ...
                                        <li role="presentation" class=""><a href="#tab_content2" role="tab"
                                                id="profile-tab" data-toggle="tab" aria-expanded="false">Projects Worked
                                                on</a>
                                        </li>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="message_wrapper">
                                                        ...
                                                        <blockquote class="message">Raw denim you
                                                            ...
                                                            Nesciunt tofu stumptown aliqua butcher retro
...
@section('js')
    <!-- morris.js -->
    <script src="{{ asset('public/front-end/admin/vendors/raphael/raphael.min.js') }}"></script>
    <script src="{{ asset('public/front-end/admin/vendors/morris.js/morris.min.js') }}"></script>
